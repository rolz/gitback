...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {/** @jsx React.DOM */App = React.createClass({displayName: "App",
	  render:function() {
	    return (
	      React.createElement("div", null, "hello7")
	    );
	  }
	});
	module.exports = App;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "body{background:gray}", ""]);
